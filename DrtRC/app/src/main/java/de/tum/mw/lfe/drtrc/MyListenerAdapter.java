...
public class MyListenerAdapter implements SerialInputOutputManager.Listener {

    public final static String TAG = "MyListenerAdapter";
    ...
    public MyListenerAdapter(MainActivity parent){
        mParent = parent;
    ...
    class readLineRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (temp != null) mParent.addToReportView(temp);//forward to parent to show on report view
            return;
        }
    ...
    class logLineRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mStr != null) mParent.addToReportView(">>>USB " +mStr);//forward to parent to log
